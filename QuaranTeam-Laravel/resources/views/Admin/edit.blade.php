...
@section('content')
  ...
  <div class="py-5 bg-custom">
      ...
      <div class="container p-3 d-flex flex-row justify-content-center align-items-center">
        ...
        <form method="GET" action="/admin/update/{{ $userdata->userId }}" >
            ...
            <div class="d-flex shadow p-3 bg-white rounded">
              ...
              <div class="col col-md">
                ...
                <div class="form-group">
                  ...
                  <input type="name" class="form-control" id="name" name="name" placeholder="Your name" value="{{ $userdata->name }}" >
                  @if($errors->has('name'))
                      <div class="text-danger">
                          {{ $errors->first('name')}}
                      </div>
                ...
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="isAdmin" name="isAdmin" value="1" {{ ($userdata->isAdmin == 1 ? 'checked' : '') }}  >
                ...
                <div class="container d-flex flex-row justify-content-center mt-2">
                  <div class="mr-3">
                    <button class="btn btn-success btn-md-6" type="submit" name="edit" id="submit" value="submit">Submit</button>
                  </div>
                  <div class="ml-3">
                    <a class="btn btn-danger btn-md-6" type="reset" href="/admin">Cancel</a>
                  </div>
                </div>
